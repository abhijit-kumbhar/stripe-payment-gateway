...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51PpoqS2LLGtvsxfA62ZEdwqmowJ4o40KzQJPk8zhTDzR62nJTa7mDJYaPAT5mGkaE4mtWelf7mq7c893d7jFDTgh006QXlqOsE");
        ...
        const response = await fetch("https://stripe-payment-api-one.vercel.app/api/create-checkout-session",{
            method:"POST",
            headers:headers,
